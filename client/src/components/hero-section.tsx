      ...
      <div ref={ref} className="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
          <Button 
            ...
            className="bg-gold hover:bg-yellow-500 text-rich-black font-semibold px-10 py-6 text-lg rounded-lg transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl"
          >
